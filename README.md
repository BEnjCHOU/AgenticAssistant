...
5. [Example Five](example_five/README.md) - (In progress)let's add a UI and use PostgreSql pgvector to store data. (We can further use Oauth to sync like google drive data to search or get summary.)
